...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    LARGE_P = 486,                 /* LARGE_P  */
    LAST_P = 487,                  /* LAST_P  */
    LATERAL_P = 488,               /* LATERAL_P  */
    LEADING = 489,                 /* LEADING  */
    LEAKPROOF = 490,               /* LEAKPROOF  */
    LEFT = 491,                    /* LEFT  */
    LEVEL = 492,                   /* LEVEL  */
    LIKE = 493,                    /* LIKE  */
    LIMIT = 494,                   /* LIMIT  */
    ...
    METHOD = 508,                  /* METHOD  */
    MICROSECOND_P = 509,           /* MICROSECOND_P  */
    MICROSECONDS_P = 510,          /* MICROSECONDS_P  */
    MILLENNIA_P = 511,             /* MILLENNIA_P  */
    MILLENNIUM_P = 512,            /* MILLENNIUM_P  */
    ...
    VACUUM = 715,                  /* VACUUM  */
    VALID = 716,                   /* VALID  */
    VALIDATE = 717,                /* VALIDATE  */
    VALIDATOR = 718,               /* VALIDATOR  */
    VALUE_P = 719,                 /* VALUE_P  */
    VALUES = 720,                  /* VALUES  */
    VARCHAR = 721,                 /* VARCHAR  */
